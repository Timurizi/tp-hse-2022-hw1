...
names = Contact()
print('Введите название файла с учётом типа')
file =  input()
names.read_txt(file)
print('Введите номер для поиска по имени')
user_number = input()
names.number_finder(user_number)
print('Введите почту для поиска по адресу электронной почты')
user_mail = input()
names.mail_finder(user_mail)
print('Введите Фамилию, Имя, Отчество как в отдельности, так и вместе для поиска по Фамилии, Имени, Отчеству')
user_name = input()
names.names_resulter(user_name)
print('Пользователи без номера телефона и/или адреса электронной почты')
names.rat_finder()